...
namespace GestorStock.BD.Data.Entity
{
    public class ProductoCompuesto
    {
        ...
        [Required(ErrorMessage = "Los ELEMENTOS del PRODUCTO COMPUESTO son Obligatorios")]
        [MaxLength(100, ErrorMessage = "Solo se aceptan hasta 100 caracteres en los ELEMENTOS")]
